...
| p_reorder | Rolling (%) | Window (W=5) (%) | 差分 |
|-----------|-------------|------------------|------|
| 0.0       | 100.00      | 100.00           | 0    |
| 0.1       | 93.55       | 100.00           | **+6.45** |
| 0.3       | 84.47       | 99.88            | **+15.41** |
| 0.5       | 77.62       | 99.88            | **+22.26** |
| 0.7       | 78.33       | 99.90            | **+21.57** |
...
1. **Replay Attack Detection**:
   - Perrig, A., et al. "SPINS: Security Protocols for Sensor Networks." *Wireless Networks* 8.5 (2002): 521-534.

2. **Sliding Window Protocol**:
   - Tanenbaum, A. S., & Wetherall, D. J. *Computer Networks* (5th ed.). Prentice Hall, 2011.

3. **Message Authentication Codes**:
   - Bellare, M., et al. "Keying Hash Functions for Message Authentication." *CRYPTO* 1996.

4. **Wireless Channel Models**:
   - IEEE 802.11 Working Group. "Wireless LAN Medium Access Control (MAC) and Physical Layer (PHY) Specifications."
